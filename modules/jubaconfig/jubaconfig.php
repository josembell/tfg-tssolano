...
class Jubaconfig extends Module
{
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'name' => 'JUBACONFIG_ACCOUNT_EMAIL',
                        'label' => $this->l('Email'),
                    ),
                    array(
                        'type' => 'password',
                        'name' => 'JUBACONFIG_ACCOUNT_PASSWORD',
    ...
    {
        return array(
            'JUBACONFIG_LIVE_MODE' => Configuration::get('JUBACONFIG_LIVE_MODE', true),
            'JUBACONFIG_ACCOUNT_EMAIL' => Configuration::get('JUBACONFIG_ACCOUNT_EMAIL', 'contact@prestashop.com'),
            'JUBACONFIG_ACCOUNT_PASSWORD' => Configuration::get('JUBACONFIG_ACCOUNT_PASSWORD', null),
        );
    }
